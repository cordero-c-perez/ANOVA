...
The ANOVA is a great way to determine if there are any statistically significant differences between the averages of three or more independent groups. In this case we want to determine if there are any significant differences between the average number of citibike trips across twelve months  
