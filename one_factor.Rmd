...
The following code prepares the data for visual inspection (anova format, aggregated bymonth and day) and produces a histogram of each sample.
&nbsp;  

```{r, include = TRUE, echo = TRUE, message = FALSE, comment = FALSE, warning = FALSE, fig.align = 'center'}
...
Again, a p-value greater than the level of significance shows a failure to reject the null hypothesis, which is what is need to verify the assumption.
&nbsp;  
