...
reduced_january <- population_january %>% filter(tripduration > 120 & tripduration < 86400)
reduced_april <- population_april %>% filter(tripduration > 120 & tripduration < 86400)
reduced_july <- population_july %>% filter(tripduration > 120 & tripduration < 86400)
reduced_october <- population_october %>% filter(tripduration > 120 & tripduration < 86400)
...
list_samples <- lapply(list_populations, sample_n, 1000)
